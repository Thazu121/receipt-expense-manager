...
export default function SideNavbar() {
  ...
  return (
    <>
      ...
      {/* ================= MOBILE SIDEBAR ================= */}
      <aside
        className={`fixed top-0 left-0 h-full w-56 z-50 bg-white dark:bg-[#0F172A]
        p-4 shadow-lg transform transition-transform duration-300
      ...
      <aside
        className={`hidden lg:flex ${
          collapsed ? "w-16" : "w-56"
        } h-screen p-4 flex-col bg-white dark:bg-[#0F172A]
