  ...
  return (
    <>
      <div className="lg:hidden sticky top-0 z-40 flex items-center justify-between px-4 py-3 bg-white dark:bg-[#0F172A] border-b border-gray-200 dark:border-gray-800">
        ...
        >
          <Menu className="text-gray-700 dark:text-gray-300" size={22} />
        </button>
      </div>
      ...
      <aside
        className={`fixed top-0 left-0 h-dvh w-[82%] max-w-[280px] z-50 bg-white dark:bg-[#0F172A]
      ...
      >
        <div className="flex justify-between items-center mb-6">
          ...
          <button
            ...
            className="p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800"
          >
            <X className="text-gray-700 dark:text-gray-300" size={22} />
          </button>
        </div>
      ...
      <aside
        className={`hidden lg:flex ${
          collapsed ? "w-20" : "w-60"
        } h-screen sticky top-0 p-4 flex-col bg-white dark:bg-[#0F172A]
